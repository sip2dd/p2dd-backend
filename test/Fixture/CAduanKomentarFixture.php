...
/**
 * CAduanKomentarFixture
 *
 */
class CAduanKomentarFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'komentar' => ['type' => 'string', 'length' => 1000, 'default' => null, 'null' => false, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        'pengguna' => ['type' => 'string', 'length' => 255, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'c_aduan_komentar_instansi_id' => ['type' => 'index', 'columns' => ['instansi_id'], 'length' => []],
            'c_aduan_komentar_data_labels' => ['type' => 'index', 'columns' => ['data_labels'], 'length' => []],
            'c_aduan_komentar_del' => ['type' => 'index', 'columns' => ['del'], 'length' => []],
            'c_aduan_komentar_dibuat_oleh' => ['type' => 'index', 'columns' => ['dibuat_oleh'], 'length' => []],
            'c_aduan_komentar_tgl_dibuat' => ['type' => 'index', 'columns' => ['tgl_dibuat'], 'length' => []],
            'c_aduan_komentar_diubah_oleh' => ['type' => 'index', 'columns' => ['diubah_oleh'], 'length' => []],
            'c_aduan_komentar_tgl_diubah' => ['type' => 'index', 'columns' => ['tgl_diubah'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'pengguna' => 'Lorem ipsum dolor sit amet'
            ],
        ];
        parent::init();
    }
