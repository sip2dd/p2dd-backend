...
require_once EasyReport::EASY_REPORT_DIR . 'EasyReport/Widget.php';
require_once EasyReport::EASY_REPORT_DIR . 'EasyReport/Widget/Table.php';
//require_once './src/Library/PHP-Easy-Report/src/EasyReport/Widget/Xml/table.php';
...
class EasyReport
{
	...
	CONST EASY_REPORT_DIR = WWW_ROOT . '/../src/Library/PHP-Easy-Report/src/';
	...
	public function create($outputFile, $data)
	{
		...
		$outputFormat = $this->getFileExtension($outputFile);
      ...
      file_put_contents($stylesXmlFile, $newStyles);
			...
			if($outputFormat != self::ODT_EXTENSION){
		        ...
		        $convertedFileName = str_replace('.odt', '.'.$outputFormat, $temporalOdtFile);
