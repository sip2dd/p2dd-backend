...
namespace App\Library\Farit_Pdf;

/** Zend_Pdf */
//require_once(ROOT . '/vendor/zf1/zend-pdf/library/Zend/Pdf.php');
//require_once(ROOT . '/vendor/zf1/zend-pdf/library/Zend/Pdf/Exception.php');
use Zend_Pdf;
use Zend_Pdf_Exception;
use Zend_Pdf_Element_Dictionary;
use Zend_Pdf_Element_Name;
use Zend_Pdf_Element_Array;
use Zend_Pdf_Element_Numeric;
use Zend_Pdf_Element_String;
use App\Library\Farit_Pdf\Farit_Pdf_ElementRaw;
...
class Farit_Pdf extends Zend_Pdf {
    ...
    const SIGNATURE_MAX_LENGTH = 117420;
