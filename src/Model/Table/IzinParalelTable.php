 ...
 * @property \Cake\ORM\Association\BelongsTo $IzinParalels
 * @property \Cake\ORM\Association\HasMany $IzinParalel
 */
class IzinParalelTable extends AppTable
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['izin_paralel_id'], 'JenisIzin'));
        return $rules;
    }
}
