 ...
 * @property \App\Model\Table\PageContentTable|\Cake\ORM\Association\HasMany $PageContent
 * @property \App\Model\Table\PageTabTable|\Cake\ORM\Association\HasMany $PageTab
 *
 ...
 */
class PageTable extends AppTable
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('PageContent', [
            'foreignKey' => 'page_id'
        ]);
        $this->hasMany('PageTab', [
            'foreignKey' => 'page_id'
        ]);
