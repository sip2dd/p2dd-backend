...
/**
 * ReportComponentsFixture
 *
 */
class ReportComponentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'report_components_jenis_izin_id' => ['type' => 'index', 'columns' => ['jenis_izin_id'], 'length' => []],
            'report_components_instansi_id' => ['type' => 'index', 'columns' => ['instansi_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'tgl_dibuat' => 1502643394,
            'tgl_diubah' => 1502643394,
