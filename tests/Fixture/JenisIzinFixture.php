 ...
 *
 */
class JenisIzinFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'jenis_izin' => ['type' => 'string', 'length' => 25, 'default' => null, 'null' => false, 'comment' => null, 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'jenis_izin' => 'Lorem ipsum dolor sit a',
            'dibuat_oleh' => 'Lorem ipsum dolor sit a',
            'tgl_dibuat' => '2016-06-04',
            'diubah_oleh' => 'Lorem ipsum dolor sit a',
            'tgl_diubah' => '2016-06-04',
            'unit_id' => 1
        ],
    ];
}
